...
radio.onReceivedValue(function (name, value) {
    if (name == "servo" && value == 1) {
        kitronik_simple_servo.setServoAngle(kitronik_simple_servo.ServoChoice.servo1, 150)
    } else {
        kitronik_simple_servo.setServoAngle(kitronik_simple_servo.ServoChoice.servo1, 45)
    }
})
